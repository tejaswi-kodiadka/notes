...
\begin{proof}
  Consider a general elliipse centered at the origin, with aligned axes, $E_1:\displaystyle\frac{x^2}{a^2}+\frac{y^2}{b^2}=1$ \\
...
\begin{proof}
  Consider a general hyperbola centerd at the origin with aligned axes, $H_1:\displaystyle\frac{x^2}{a^2}-\frac{y^2}{b^2}=1$ \\
  With a translation to move the center to the origin and a rotation to align the axes, any
